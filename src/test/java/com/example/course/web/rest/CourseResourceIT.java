...
import static com.example.course.domain.CourseAsserts.*;
...
class CourseResourceIT {
    ...
    public static Course createEntity() {
        return new Course().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION);
    }
    ...
    public static Course createUpdatedEntity() {
        return new Course().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
    }
    ...
    void putExistingCourse() throws Exception {
        ...
        updatedCourse.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION);
